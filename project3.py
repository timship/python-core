"""
Задание №3
Реализуйте класс InventoryManager для учета товаров на складе. Каждый товар имеет уникальный артикул - item_id, название, цену и количество на складе. Система должна поддерживать базовые операции: добавление, продажа, проверка остатков.
...
Используйте словарь для хранения товаров, где ключ – item_id, а значение – другой словарь с информацией о товаре
