"""
Реализуем систему управления историей посещений браузера с возможностью отмены (undo) и возврата (redo) действий. 
История должна вести себя как стек, где каждая новая страница добавляется наверх, а при навигации "назад" (undo) мы возвращаемся к предыдущей странице.

Реализуем класс BrowserHistory с методами:
