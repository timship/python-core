"""
Реализуем класс SubscriptionManager для управления подписками пользователей на различные категории контента. 
Каждый пользователь может подписываться или отписываться от категорий, а система должна быстро отвечать на вопросы о подписках.
