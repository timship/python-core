"""
Задание №4
Вы разрабатываете систему обработки очереди в банковском отделении. Клиенты приходят в случайном порядке, но система должна обрабатывать их в порядке поступления (FIFO), однако среди клиентов есть со статусом VIP, которые имеют более высокий приоритет в обслуживании чем приоритетные.

Реализуйте класс ClientsQueue, который:
